...
The microservice is responsible for feeding the Elasticsearch so [product search microservice](https://github.com/shopsys/microservice-product-search) can work properly.
